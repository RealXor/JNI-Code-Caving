...
# NOTE
This is only a POC, this is not meant to be *actually* used, rather it should be **applied**, thus the code isn't fully worked out and there are major problems with it. However, it does what it is supposed to do.
